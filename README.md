...
6. In order to get the mini-dataset, you can refer to https://github.com/WZMIAOMIAO/deep-learning-for-image-processing
7. Create attack dataset from NIPS 2017 dataset, you need run `Rename_image.py` in `mini_dataset`.
